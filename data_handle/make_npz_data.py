...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_dir', type=str,
                        default=r'D:\DataBase\archive\dataset\semantic_drone_dataset\original_images', help='图像路径')
    parser.add_argument('--label_dir', type=str,
                        default=r'D:\DataBase\archive\dataset\semantic_drone_dataset\label_images_semantic', help='掩码图路径')
    parser.add_argument('--save_dir', type=str,
                        default=r'D:\DataBase\archive\dataset\semantic_drone_dataset\npz', help='保存路径')
