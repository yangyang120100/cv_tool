...
"""
# ==== 配置区域 ====
json_dir = r"D:\DataBase\cabel_train_datas\jsons"   # LabelMe JSON 文件夹
img_dir = r"D:\DataBase\cabel_train_datas\images" # 图片文件夹（可选，用于获取图片大小）
save_dir = r"D:\DataBase\cabel_train_datas\labels" # 输出 YOLO txt 文件夹
classes = ['cable','white_cable']  # 按顺序填写类别名称
# =================
